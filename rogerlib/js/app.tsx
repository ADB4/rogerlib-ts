...
import { ColorModeContextType, ColorModeContext } from './context/galleryContext';
...
*/
    ...
    let publicLaunch = {
        color: darkMode ? colorScheme.beanTextColors[0] : colorScheme.beanTextColors[1],
        transition: "all .5s ease",
        WebKitTransition: "all .5s ease",
        MozTransition: "all .5s ease",
    };
    let webHeader = {
        fontSize: compactView ? ("2.0rem") : ("1.3rem"),
    };
